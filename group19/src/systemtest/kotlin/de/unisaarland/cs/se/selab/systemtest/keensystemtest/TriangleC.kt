 ...
 *
 */
class TriangleC : SystemTest() {
    override val name = "TriangleC"
    override val map = "mapFiles/triangleMaps/triangle_b_c.dot"
    ...
    override suspend fun run() {
        assertNextLine("Initialization Info: triangle_b_c.dot invalid")
        assertEnd()
    }
}
