 ...
 *
 */
class TriangleG : SystemTest() {
    override val name = "TriangleG"
    override val map = "mapFiles/triangleMaps/triangle_b_g.dot"
    ...
    override suspend fun run() {
        assertNextLine("Initialization Info: triangle_b_g.dot invalid")
        assertEnd()
    }
}
