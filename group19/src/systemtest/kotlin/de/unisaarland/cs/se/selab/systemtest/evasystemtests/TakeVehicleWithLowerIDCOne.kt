...
private const val TVWLIDCONEMAXTICK = 10

/**
 * TODO
 *
 */
class TakeVehicleWithLowerIDCOne : SystemTest() {

    override val name = "TakeVehicleWithLowerIDCONE"

    override val map = "mapFiles/take_route_with_lower_id_three_map.dot"
    override val assets = "assetsJsons/take_vehicle_with_lower_id_c_one_assets.json" //
    override val scenario = "scenarioJsons/take_route_with_lower_id_one_scenario.json"

    override val maxTicks = TVWLIDCONEMAXTICK
    override suspend fun run() {
        assertNextLine("Initialization Info: take_route_with_lower_id_three_map.dot successfully parsed and validated")
        assertNextLine(
            "Initialization Info: take_vehicle_with_lower_id_c_one_assets.json successfully parsed and validated"
        )
        assertNextLine(
