...
private const val TRWLIDOEMAXTICK = 10

/**
 * TODO
 *
 */
class TakeRouteWithLowerIDThreeOtherEvent : SystemTest() {
    ...
    override val scenario = "scenarioJsons/take_route_with_lower_id_other_event_scenario.json"

    override val maxTicks = TRWLIDOEMAXTICK
    override suspend fun run() {
        assertNextLine("Initialization Info:  .dot successfully parsed and validated")
        assertNextLine(
            "Initialization Info: take_route_with_lower_id_one_assets.json successfully parsed and validated"
        )
        assertNextLine(
            "Initialization Info: take_route_with_lower_id_other_event_scenario.json successfully parsed and validated"
        )
