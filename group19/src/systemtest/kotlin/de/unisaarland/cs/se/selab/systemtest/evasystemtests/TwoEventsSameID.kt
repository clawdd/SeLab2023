 ...
 *
 */
class TwoEventsSameID : SystemTest() {

    override val name = "TwoEmergencySameID"

    override val map = "mapFiles/standard_map.dot"
    override val assets = "assetsJsons/standard_assets.json"
    override val scenario = "scenarioJsons/two_events_same_id_scenario.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("Initialization Info: two_events_same_id_scenario.json invalid")
        assertEnd()
    }
}
