...
private const val TRWLIDTWOMAXTICK = 10

/**
 * TODO
 *
 */
class TakeRouteWithLowerIDTwo : SystemTest() {

    override val name = "TakeRouteWithLowerIDTwo"

    override val map = "mapFiles/take_route_with_lower_id_two_map.dot"
    ...
    override val maxTicks = TRWLIDTWOMAXTICK
    override suspend fun run() {
        assertNextLine("Initialization Info: take_route_with_lower_id_two_map.dot successfully parsed and validated")
        assertNextLine(
